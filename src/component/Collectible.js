  ...
  return (
    <div className="dashboard-wrapper-main artist-management">
            ...
            <div className="nft">
              ...
              <div className="details">
                <div className="info">
                  ...
                  {data?.maxSupply && (
                    <h4 className="prints">
                      {data?.supply} prints created [max. {data?.maxSupply}]
                    </h4>
                  )}
                </div>
      ...
      >
        ...
        <Modal.Footer>
          <button className="save-btn btn-gradiant">Buy</button>
        </Modal.Footer>
      </Modal>
      <Modal
        show={showSell}
      ...
      >
        ...
        <Modal.Footer>
          <button className="save-btn btn-gradiant">Sell</button>
        </Modal.Footer>
      </Modal>
    </div>
  );
