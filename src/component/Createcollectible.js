...
const Createcollectible = (props) => {
    ...
    const convertRoyalties = () => {
        ...
        for (var el in royaltySplits) {
            royalities.push({
                address: royaltyWallets[el],
                value: parseFloat(royaltySplits[el])
            });
        }
        return royalities;
    };
    ...
    const createERC721 = async (ipfsHash) => {
        ...
        history.push(`/collectible/${ipfsHash}`);
    };
                ...
                <div className="col-lg-6 col-md-6">
                    <div className="card create-collectible">
                        ...
                        <div className="create-collectible-upload-description">
                            <h3>PNG, GIF, WEBP, MP4 or MP3</h3>
                            <p>Max 50 MB</p>
                        </div>
                        <div className="footer-btn">
                            <button
                                className="btn-gradiant"
                                onClick={() => uploadButtonRed.current.click()}
                            >
                                Choose File
                            </button>
                            <input
                    ...
                    <div className="card create-collectible">
                        ...
                        <div className="create-collectible-preview-description">
                            {previewUrl ? (
                                ...
                                <h3>Upload file to preview your NFT</h3>
                            )}
                        </div>
                        {!previewUrl && <div />}
                    </div>
            ...
            <div className="row row-wrap">
                <div className="col-lg-6 col-md-6 mt-4">
                    <div className="card create-collectible collectible-data">
                        ...
                        <div className="pricing">
                            <div
                                className={`option ${pricingType === 'fixed-price' && 'selected'}`}
                            ...
                            <div
                                className={`option ${
                                    pricingType === 'unlimited-collection' && 'selected'
                                }`}
                        ...
                        <div className="input-price">
                            <div className="data">
                                <input
                                    type="number"
                                    placeholder="Enter price of one piece"
                            ...
                            <div className="info">
                                <div>
                                    Service fee is <span>1.5%</span>
                                </div>
                                <div>
                                    You will receive <span>${feePrice.toFixed(2)} USD</span>
                                </div>
                            </div>
                        </div>
                        ...
                        {quantity === 'multiple' && (
                            <span className="graphic-title">Choose Price Graph</span>
                        )}
                        {quantity === 'multiple' && (
                        ...
                        <div className="additional-data">
                            ...
                            <input
                                type="number"
                                className="input"
                                name="royalties-number"
                                placeholder="Royalties (e.g. 10%, 20%, 30%)"
                                required
                                value={royalty}
                ...
                <div className="col-lg-6 col-md-6 mt-4">
                    <div className="card create-collectible">
                            ...
                            {splitRoyaltiesArray.map((item, index) => (
                                <div key={item} className="royalty-input-wrapper">
                                    <input
                                        ...
                                        placeholder="%"
                                        onChange={(e) => {
                                            royaltySplits[`percentage${index + 1}`] =
                                                e.target.value;
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => {
                                            royaltyWallets[`percentage${index + 1}`] =
                                                e.target.value;
                                ...
                                <div className="song-button">
                                    ...
                                    <div className="button">
                                        <button
                                            ...
                                            type="button"
                                            onClick={() =>
                                                setSplitRoyaltiesCount((counter) => counter + 1)
                                            }
                                        >
                                            <span>+</span>
                                        </button>
                        ...
                        <div className="footer-btn">
                            <button className="btn-gradiant">Save Split</button>
                        </div>
                    </div>
                </div>
            </div>
