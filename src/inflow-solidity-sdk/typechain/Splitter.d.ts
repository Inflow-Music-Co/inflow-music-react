...
interface SplitterInterface extends ethers.utils.Interface {
    functions: {
        ...
        'updateRoyaltyAccount(address,uint256,address)': FunctionFragment;
    };

    encodeFunctionData(functionFragment: 'batchRelease', values: [string[]]): string;
...
export class Splitter extends BaseContract {
    ...
    functions: {
        ...
        payee(idx: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
    ...
    callStatic: {
        batchRelease(payees: string[], overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        ...
        PayeeAdded(
            account?: null,
            shares_?: null
        ): TypedEventFilter<[string, BigNumber], { account: string; shares_: BigNumber }>;
    ...
    estimateGas: {
        ...
        payee(idx: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        payee(idx: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
