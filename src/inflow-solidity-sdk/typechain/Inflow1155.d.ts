...
export class Inflow1155 extends BaseContract {
    ...
    functions: {
        ...
        uri(tokenId: BigNumberish, overrides?: CallOverrides): Promise<[string] & { uri_: string }>;
    ...
    callStatic: {
        ...
        burn(tokenId: BigNumberish, amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        ...
        mint(tokenId: BigNumberish, amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
