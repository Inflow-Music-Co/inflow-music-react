...
exports.getEventData = exports.getTxEventData = void 0;
function getTxEventData(input, eventFragment, contractInterface, _idx) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    logs = (_b.sent()).logs;
                    idx = _idx !== null && _idx !== void 0 ? _idx : logs.length - 1;
                    return [2 /*return*/, contractInterface.decodeEventLog(eventFragment, logs[idx].data, logs[idx].topics)];
            }
        });
    });
}
