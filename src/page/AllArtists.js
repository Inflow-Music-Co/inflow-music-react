...
const AllArtists = () => {
    ...
    return artists.map((artist, i) => {
      return (
        <tr key={i}>
          ...
          <td>
            <Button variant="primary" id={artist._id} onClick={openEditModal}>
              EDIT
            </Button>
          </td>
        </tr>
  ...
  const deleteArtist = async () => {
    setloading(true);
    await Axios.patch(
      `${process.env.REACT_APP_SERVER_URL}/v1/artist/deactivate`,
      { id: mid }
    );
    await getArtists();
    setmodal(false);
          ...
          <div className="grids-main-inputs">
            ...
            <div className="comman-grids">
              <Form.Group>
                ...
                <Form.Control
                  type="text"
                  value={msocialtokenaddress}
                  onChange={(e) => setmsocialtokenaddress(e.target.value)}
                />
              </Form.Group>
            </div>
            <div className="comman-grids">
              <Form.Group>
                ...
                <Form.Control
                  type="text"
                  value={mwalletaddress}
                  onChange={(e) => setmwalletaddress(e.target.value)}
                />
              </Form.Group>
            </div>
            <div className="comman-grids">
              <Form.Group>
                ...
                <Form.Control
                  type="text"
                  value={mtokensymbol}
                  onChange={(e) => setmtokensymbol(e.target.value)}
                />
              </Form.Group>
            </div>
            <div className="comman-grids"></div>
            <div className="comman-grids">
              Update Profile Image:
              <input
                onChange={(e) => setmprofileimage(e.target.files[0])}
            ...
            <div className="comman-grids">
              Update Banner Image:
              <input
                onChange={(e) => setmbannerimage(e.target.files[0])}
