...
const AllArtists = () => {
    ...
    const getArtists = async () => {
        try {
            ...
            const { data } = await Axios.get(
                `${process.env.REACT_APP_SERVER_URL}/v1/artist/getallapproval`,
    ...
    const handleApprove = async (e) => {
        ...
        try {
            alert('minting artist social token!');
            await Axios.patch(`${process.env.REACT_APP_SERVER_URL}/v1/artist/activate`, {
                id: e.target.id
            });
        } catch (e) {
            console.log(e);
