    ...
    const getTokenBalance = async (tokenaddress) => {
        if (walletProvider) {
            try {
                ...
                const balance = await inflow.balanceOf('SocialToken', signerAddress, tokenaddress);
            ...
            <Grid container direction="row">
                ...
                <Grid item xs={3}>
                    {isArtist ? (
                        ...
                        <Button variant="contained" style={{ borderRadius: 40 }} onClick={onCreate}>
                    ...
                    <div className="artist-holdings">
                        ...
                        <div className="artist-holdings-total m-auto col-12 d-flex align-items-center">
                            <div className="artist-holdings-inner d-flex flex-column">
                                <span className="d-flex flex-row" style={{ fontSize: '1.1rem' }}>
                                    {formattedAddress ? (
                ...
                <div className="chart-header-row">
                    <Grid container direction="column" alignItems="center" justify="center">
                        <Grid item style={{ paddingBottom: 10 }}>
                            {usdcBalance ? (
                                <div className="right-side-value">total usdc : ${usdcBalance}</div>
                            ) : (
                                <span>loading ... </span>
                            )}
                        </Grid>
