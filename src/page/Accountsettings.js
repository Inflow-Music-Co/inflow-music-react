...
const Accountsettings = () => {
    ...
    useEffect(() => {
        resetpasswordemailsent &&
            MySwal.fire({
                ...
                html: <p style={{ color: 'white' }}>Check your email for password reset</p>,
                icon: 'success',
                customClass: {
                ...
                setresetpasswordemailsent((resetpasswordemailsent) => !resetpasswordemailsent);
            });
    }, [resetpasswordemailsent]);
    ...
    const forgotPassword = async () => {
        try {
            await Axios.post(`${process.env.REACT_APP_SERVER_URL}/v1/user/resetpassword`, {
                                    ...
                                    <>
                                        ...
                                        <div className="comman-grids">
                                            <input
                                                ...
                                                value={
                                                    artistSocial ? artistSocial['socialTwo'] : null
                                                }
                                                onChange={(e) =>
                                                    setArtistSocial((artistSocial) => {
                                                        return {
