    ...
    useEffect(() => {
        artistcreationfailure &&
            MySwal.fire({
                ...
                html: <p style={{ color: 'white' }}>Check the wallet address and Try again</p>,
                icon: 'error',
                customClass: {
                    confirmButton: 'btn-gradiant'
                },
    ...
    useEffect(() => {
        existingsocialtoken &&
            MySwal.fire({
                title: <p style={{ color: 'white' }}>Error</p>,
                html: (
                    <p style={{ color: 'white' }}>Social Token for given wallet already exists</p>
                ),
                icon: 'error',
                customClass: {
                    confirmButton: 'btn-gradiant'
    ...
    useEffect(() => {
        artistemailexists &&
            MySwal.fire({
                title: <p style={{ color: 'white' }}>Error</p>,
                html: (
                    <p style={{ color: 'white' }}>Artist Token with provided email doesn't exist</p>
                ),
                icon: 'error',
                customClass: {
                    confirmButton: 'btn-gradiant'
            ...
            <div className="dashboard-wrapper-main vw-100 d-flex flex-column justify-content-center align-items-center">
                ...
                <div className="tab-settings-main">
                    ...
                    <div className="tab-content pt-3" id="nav-tabContent">
                        ...
                        <h2 className="p-3 my-3">Social token address is : {socialtokenid}</h2>
                    </div>
                </div>
            </div>
        </>
